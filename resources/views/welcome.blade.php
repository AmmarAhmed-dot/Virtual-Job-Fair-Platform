        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                <div
                    ...
                    <h3 class="text-2xl font-bold mb-4">Live Interviews</h3>
                    <p class="text-gray-600 leading-relaxed">Real-time video and audio communication between recruiters
                        and candidates seamlessly integrated.</p>
                </div>
                <div
                    ...
                    <p class="text-gray-600 leading-relaxed">Craft a professional CV with our AI-powered suggestions and
                        modern templates designed for success.</p>
                </div>
                <div
