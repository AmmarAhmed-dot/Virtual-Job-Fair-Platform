    ...
    <x-slot name="header">
        <div class="flex items-center space-x-4">
            ...
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Virtual Interview Room') }} - {{ $application->jobPosting->title }}
            </h2>
        </div>
    </x-slot>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700 font-medium" id="meeting-note-text">
                            <strong>Security Verification:</strong> To ensure a secure interview environment, the meeting host must verify their identity. If prompted that moderators have not arrived, please click the <strong>Log-in</strong> button within the video window to authenticate and begin the session.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-black overflow-hidden shadow-xl sm:rounded-2xl flex-1 border border-gray-700 relative">
                ...
                <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div class="text-white text-center">
                        ...
                        <p class="font-bold text-sm tracking-widest uppercase">Connecting to secure room...</p>
                    </div>
                </div>
