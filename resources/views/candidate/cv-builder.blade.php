<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <button type="button" onclick="let origTitle = document.title; document.title = '{{ str_replace(' ', '_', auth()->user()->name) }}_CV'; window.print(); document.title = origTitle;"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div class="lg:col-span-5 space-y-6 no-print">
                    <form action="{{ route('candidate.cv-store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="bg-white rounded-2xl border border-gray-200/80 shadow-sm overflow-hidden">
                            ...
                            <div class="flex border-b overflow-x-auto bg-gray-50/50">
                                <button type="button" @click="activeTab = 'personal'"
                                    :class="activeTab === 'personal' ? 'border-indigo-600 text-indigo-600 bg-white' : 'border-transparent text-gray-500 hover:text-gray-700'"
                                    class="whitespace-nowrap px-4 py-3 border-b-2 text-xs font-bold transition">Contact</button>
                                <button type="button" @click="activeTab = 'skills'"
                                    :class="activeTab === 'skills' ? 'border-indigo-600 text-indigo-600 bg-white' : 'border-transparent text-gray-500 hover:text-gray-700'"
                                    class="whitespace-nowrap px-4 py-3 border-b-2 text-xs font-bold transition">Skills</button>
                                <button type="button" @click="activeTab = 'experience'"
                                    :class="activeTab === 'experience' ? 'border-indigo-600 text-indigo-600 bg-white' : 'border-transparent text-gray-500 hover:text-gray-700'"
                                    class="whitespace-nowrap px-4 py-3 border-b-2 text-xs font-bold transition">Experience</button>
                                <button type="button" @click="activeTab = 'projects'"
                                    :class="activeTab === 'projects' ? 'border-indigo-600 text-indigo-600 bg-white' : 'border-transparent text-gray-500 hover:text-gray-700'"
                                    class="whitespace-nowrap px-4 py-3 border-b-2 text-xs font-bold transition">Projects</button>
                                <button type="button" @click="activeTab = 'education'"
                                    :class="activeTab === 'education' ? 'border-indigo-600 text-indigo-600 bg-white' : 'border-transparent text-gray-500 hover:text-gray-700'"
                                    class="whitespace-nowrap px-4 py-3 border-b-2 text-xs font-bold transition">Education</button>
                                <button type="button" @click="activeTab = 'languages'"
                                    :class="activeTab === 'languages' ? 'border-indigo-600 text-indigo-600 bg-white' : 'border-transparent text-gray-500 hover:text-gray-700'"
                                    class="whitespace-nowrap px-4 py-3 border-b-2 text-xs font-bold transition">Languages</button>
                            </div>

                            <div class="p-6">
                                <!-- Personal & Summary Info -->
                                <div x-show="activeTab === 'personal'" class="space-y-4">
                                    <h3 class="text-sm font-bold text-gray-800 uppercase tracking-wider mb-2">Personal
                                        Information</h3>
                                    <div>
                                        <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Phone
                                            Number</label>
                                        <input type="text" name="phone" x-model="cv.phone"
                                            class="w-full border-gray-300 rounded-xl focus:ring-indigo-500 focus:border-indigo-500 text-sm shadow-sm">
                                    </div>
                                    <div>
                                        <label
                                            class="block text-xs font-bold text-gray-500 uppercase mb-1">Location</label>
                                        <input type="text" name="location" x-model="cv.location"
                                            class="w-full border-gray-300 rounded-xl focus:ring-indigo-500 focus:border-indigo-500 text-sm shadow-sm"
                                            placeholder="e.g. Lahore, Pakistan">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-bold text-gray-500 uppercase mb-1">LinkedIn
                                            Username/Handle</label>
                                        <input type="text" name="linkedin_url" x-model="cv.linkedin_url"
                                            class="w-full border-gray-300 rounded-xl focus:ring-indigo-500 focus:border-indigo-500 text-sm shadow-sm"
                                    ...
                                    <div>
                                        <label class="block text-xs font-bold text-gray-500 uppercase mb-1">GitHub
                                            Username</label>
                                        <input type="text" name="github_username" x-model="cv.github_username"
                                            class="w-full border-gray-300 rounded-xl focus:ring-indigo-500 focus:border-indigo-500 text-sm shadow-sm"
                                    ...
                                    <div>
                                        <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Professional
                                            Summary</label>
                                        <textarea name="summary" x-model="cv.summary"
                                            class="w-full border-gray-300 rounded-xl focus:ring-indigo-500 focus:border-indigo-500 text-sm shadow-sm"
                                ...
                                <div x-show="activeTab === 'skills'" class="space-y-4">
                                    <div class="flex justify-between items-center mb-2">
                                        <h3 class="text-sm font-bold text-gray-800 uppercase tracking-wider">Skills
                                            Categories</h3>
                                    ...
                                    <template x-for="(skill, index) in cv.skills" :key="index">
                                        <div class="p-4 bg-gray-50/50 rounded-xl border relative mb-4">
                                            <button type="button" @click="removeSkill(index)"
                                                class="absolute top-2 right-2 text-xs text-red-500 hover:underline">Remove</button>
                                            <div class="space-y-2">
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-bold text-gray-500 uppercase mb-1">Category
                                                        Title</label>
                                                    <input type="text" :name="`skills[${index}][category]`"
                                                        x-model="skill.category"
                                                        class="w-full border-gray-300 rounded-lg text-xs py-1.5 shadow-sm"
                                                        placeholder="e.g. Languages & Frameworks">
                                                </div>
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-bold text-gray-500 uppercase mb-1">Skills
                                                        List (comma separated)</label>
                                                    <input type="text" :name="`skills[${index}][list]`"
                                                        x-model="skill.list"
                                                        class="w-full border-gray-300 rounded-lg text-xs py-1.5 shadow-sm"
                                                        placeholder="e.g. React.js, Next.js, PHP">
                                                </div>
                                            </div>
                                        </div>
                                    </template>
                                ...
                                <div x-show="activeTab === 'experience'" class="space-y-4">
                                    <div class="flex justify-between items-center mb-2">
                                        <h3 class="text-sm font-bold text-gray-800 uppercase tracking-wider">Work
                                            Experience</h3>
                                    ...
                                    <template x-for="(exp, expIdx) in cv.experience" :key="expIdx">
                                        <div class="p-4 bg-gray-50/50 rounded-xl border relative mb-4">
                                            ...
                                            <div class="grid grid-cols-2 gap-2 mb-2">
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-bold text-gray-500 uppercase mb-0.5">Role/Title</label>
                                                    <input type="text" :name="`experience[${expIdx}][role]`"
                                                        x-model="exp.role"
                                                ...
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-bold text-gray-500 uppercase mb-0.5">Company</label>
                                            ...
                                            <div class="grid grid-cols-2 gap-2 mb-2">
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-bold text-gray-500 uppercase mb-0.5">Duration</label>
                                                    <input type="text" :name="`experience[${expIdx}][duration]`"
                                                        x-model="exp.duration"
                                                        class="w-full border-gray-300 rounded-lg text-xs py-1.5"
                                                        placeholder="e.g. May 2025 -- Present">
                                                </div>
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-bold text-gray-500 uppercase mb-0.5">Location</label>
                                                    <input type="text" :name="`experience[${expIdx}][location]`"
                                                        x-model="exp.location"
                                                        class="w-full border-gray-300 rounded-lg text-xs py-1.5"
                                                        placeholder="e.g. Lahore, Pakistan">
                                                </div>
                                            </div>
                                            ...
                                            <div class="mt-3">
                                                <div class="flex justify-between items-center mb-1">
                                                    <label
                                                        class="block text-[10px] font-bold text-gray-500 uppercase">Key
                                                        Achievements</label>
                                                    <button type="button" @click="addBullet(expIdx)"
                                                        class="text-[10px] text-indigo-600 hover:underline">+ Add
                                                        Point</button>
                                                </div>
                                                <template x-for="(bullet, bulletIdx) in exp.bullets" :key="bulletIdx">
                                                    <div class="flex items-center space-x-1.5 mb-1.5">
                                                        <input type="text"
                                                            :name="`experience[${expIdx}][bullets][${bulletIdx}]`"
                                                            x-model="exp.bullets[bulletIdx]"
                                                            class="w-full border-gray-300 rounded-lg text-xs py-1 shadow-sm"
                                                            placeholder="e.g. Developed Next.js platform...">
                                                        <button type="button" @click="removeBullet(expIdx, bulletIdx)"
                                ...
                                <div x-show="activeTab === 'projects'" class="space-y-4">
                                    <div class="flex justify-between items-center mb-2">
                                        <h3 class="text-sm font-bold text-gray-800 uppercase tracking-wider">Projects
                                        </h3>
                                    ...
                                    <template x-for="(proj, index) in cv.projects" :key="index">
                                        <div class="p-4 bg-gray-50/50 rounded-xl border relative mb-4">
                                            ...
                                            <div class="space-y-2">
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-bold text-gray-500 uppercase mb-0.5">Project
                                                        Name</label>
                                                ...
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-bold text-gray-500 uppercase mb-0.5">Description</label>
                                                    <textarea :name="`projects[${index}][description]`"
                                                        x-model="proj.description"
                                                        class="w-full border-gray-300 rounded-lg text-xs py-1.5 shadow-sm"
                                                        rows="3"
                                                        placeholder="Explain the project achievements..."></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </template>
                                ...
                                <div x-show="activeTab === 'education'" class="space-y-4">
                                    <div class="flex justify-between items-center mb-2">
                                        <h3 class="text-sm font-bold text-gray-800 uppercase tracking-wider">Education
                                            History</h3>
                                    ...
                                    <template x-for="(edu, index) in cv.education" :key="index">
                                        <div class="p-4 bg-gray-50/50 rounded-xl border relative mb-4">
                                            ...
                                            <div class="grid grid-cols-2 gap-2 mb-2">
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-bold text-gray-500 uppercase mb-0.5">Degree/Major</label>
                                                ...
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-bold text-gray-500 uppercase mb-0.5">School/University</label>
                                            ...
                                            <div class="grid grid-cols-2 gap-2">
                                                <div>
                                                    ...
                                                    <input type="text" :name="`education[${index}][duration]`"
                                                        x-model="edu.duration"
                                                        class="w-full border-gray-300 rounded-lg text-xs py-1.5"
                                                        placeholder="e.g. 2020 -- 2024">
                                                </div>
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-bold text-gray-500 uppercase mb-0.5">Details
                                                        (GPA/Honors)</label>
                                ...
                                <div x-show="activeTab === 'languages'" class="space-y-4">
                                    <div class="flex justify-between items-center mb-2">
                                        <h3 class="text-sm font-bold text-gray-800 uppercase tracking-wider">Languages
                                        </h3>
                                    ...
                                    <template x-for="(lang, index) in cv.languages" :key="index">
                                        <div class="p-4 bg-gray-50/50 rounded-xl border relative mb-4">
                                            ...
                                            <div class="grid grid-cols-2 gap-2">
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-bold text-gray-500 uppercase mb-0.5">Language</label>
                                                    <input type="text" :name="`languages[${index}][name]`"
                                                        x-model="lang.name"
                                                        class="w-full border-gray-300 rounded-lg text-xs py-1.5"
                                                ...
                                                <div>
                                                    <label
                                                        class="block text-[10px] font-bold text-gray-500 uppercase mb-0.5">Proficiency</label>
                                                    <input type="text" :name="`languages[${index}][proficiency]`"
                                                        x-model="lang.proficiency"
                                                        class="w-full border-gray-300 rounded-lg text-xs py-1.5"
                                                        placeholder="e.g. IELTS 6.5 (B2)">
                                                </div>
                                            </div>
                                        </div>
                                    </template>
                        ...
                        <!-- Submit Button -->
                        <button type="submit"
                            class="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-3.5 rounded-xl font-bold transition shadow-lg shadow-indigo-100 flex items-center justify-center space-x-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div
                    ...
                    <div id="cv-preview-sheet"
                        ...
                        <div class="pb-4 mb-6">
                            <div
                                class="grid grid-cols-2 gap-y-1 gap-x-8 text-xs font-sans text-gray-600 max-w-lg mx-auto">
                                ...
                                <div class="flex items-center space-x-2" x-show="cv.linkedin_url">
                                    ...
                                    <a :href="'https://' + cv.linkedin_url" target="_blank"
                                        class="text-blue-600 hover:underline" x-text="cv.linkedin_url"></a>
                                </div>
                                <div class="flex items-center space-x-2" x-show="cv.github_username">
                                    ...
                                    <a :href="'https://github.com/' + cv.github_username" target="_blank"
                                        ...
                                        x-text="'github.com/' + cv.github_username"></a>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="w-full text-left border-collapse text-[10pt]">
                                <tbody>
                                    <template x-for="skill in cv.skills">
                                        <tr class="align-top">
                                            <td class="font-bold py-1 w-[35%] text-black" x-text="skill.category + ':'">
                                            </td>
                            ...
                            <div class="space-y-3">
                                <template x-for="proj in cv.projects">
                                    <div class="text-[10pt]">
                                        ...
                                        <a :href="proj.link" target="_blank" class="text-blue-600 hover:underline"
                                            x-text="proj.link"></a>
